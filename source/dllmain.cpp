...
// Fix Enhancers lord of the rings return of the king patches added 
...
void PerformHexEdit(LPBYTE lpAddress, DWORD moduleSize) {
    ...
    std::vector<HexEdit> edits = {
        ...
        { { 0x24, 0x44, 0x81, 0xFA, 0x80, 0x02, 0x00, 0x00, 0x0F, 0x82, 0xB0, 0x00 }, { 0x85 }, 9 },
        { { 0x24, 0x48, 0x81, 0xFB, 0xE0, 0x01, 0x00, 0x00, 0x0F, 0x82, 0xA0, 0x00 }, { 0x85 }, 9 },
        { { 0x3B, 0xC3, 0x75, 0x7E, 0x8B, 0x44, 0x24, 0x14, 0x8B, 0x7C, 0x24, 0x50 }, { 0x00 }, 3 },
    };
...
void PerformHexEdit2(LPBYTE lpAddress, DWORD moduleSize) {
    ...
    std::vector<HexEdit2> edits2 = {
        // menu issue, makes it so that only width of the resolution shows in the menu as otherwise displayed wrong
        { { 0x85, 0xC0, 0x0F, 0x8E, 0x93, 0x00, 0x00, 0x00, 0x8B, 0x7C, 0x9C, 0x18, 0x8D, 0x14, 0x7F, 0xC1, 0xEA, 0x02, 0x52 }, { 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90 }, 12 },
        { { 0x57, 0x68, 0x88, 0x64, 0x54, 0x00, 0x50, 0x56, 0xE8, 0x9B, 0x8A, 0x00, 0x00 }, { 0x8C }, 2 },
        { { 0x83, 0xC4, 0x14, 0x85, 0xC0, 0x7C, 0x72, 0x3B, 0x3D, 0xB8, 0xE7, 0x5B, 0x00, 0x75, 0x1F, 0xDB }, { 0x10 }, 2 },
    };
...
void PerformHexEdit3(LPBYTE lpAddress, DWORD moduleSize) {
    ...
    std::vector<HexEdit3> edits3 = {
        // menu issue, makes it so that only width of the resolution shows in the menu as otherwise displayed wrong
        { { 0x00, 0x00, 0x80, 0x3F, 0x00, 0x00, 0x80, 0x3F, 0x3E, 0x00, 0x00, 0x00 }, { 0x00 }, 8 },
    };
...
const std::vector<BYTE> commonHexEdit4 = { 0x80, 0x02, 0x00, 0x00, 0x0F, 0x85, 0xB0, 0x00, 0x00, 0x00, 0x8B, 0x5C, 0x24, 0x48, 0x81, 0xFB, 0xE0, 0x01 };
...
HexEdit4 CreateHexEditFromResolution(int resolutionIndex) {
    HexEdit4 edit4;

    switch (resolutionIndex) {
    case 1:
        edit4.modified4 = { 0x00, 0x05, 0x00, 0x00, 0x0F, 0x85, 0xB0, 0x00, 0x00, 0x00, 0x8B, 0x5C, 0x24, 0x48, 0x81, 0xFB, 0xD0, 0x02 };  // 1280 x 720
        edit4.offset4 = 0;
        break;
    case 2:
        edit4.modified4 = { 0x80, 0x07, 0x00, 0x00, 0x0F, 0x85, 0xB0, 0x00, 0x00, 0x00, 0x8B, 0x5C, 0x24, 0x48, 0x81, 0xFB, 0x38, 0x04 };  // 1920 x 1080
        edit4.offset4 = 0;
        break;
    case 3:
        edit4.modified4 = { 0x00, 0x0A, 0x00, 0x00, 0x0F, 0x85, 0xB0, 0x00, 0x00, 0x00, 0x8B, 0x5C, 0x24, 0x48, 0x81, 0xFB, 0xA0, 0x05 };  // 2560 x1440 
        edit4.offset4 = 0;
        break;
    case 4:
        edit4.modified4 = { 0x00, 0x0F, 0x00, 0x00, 0x0F, 0x85, 0xB0, 0x00, 0x00, 0x00, 0x8B, 0x5C, 0x24, 0x48, 0x81, 0xFB, 0x70, 0x08 };  // 3840 x 2160
        edit4.offset4 = 0;
        break;
    case 5:
        edit4.modified4 = { 0x70, 0x0D, 0x00, 0x00, 0x0F, 0x85, 0xB0, 0x00, 0x00, 0x00, 0x8B, 0x5C, 0x24, 0x48, 0x81, 0xFB, 0xA0, 0x05 };  // 3440 x 1440
        edit4.offset4 = 0;
        break;
    case 6:
        edit4.modified4 = { 0xA0, 0x05, 0x00, 0x00, 0x0F, 0x85, 0xB0, 0x00, 0x00, 0x00, 0x8B, 0x5C, 0x24, 0x48, 0x81, 0xFB, 0x84, 0x03 };  // 1440 x 900
        edit4.offset4 = 0;
        break;
    case 7:
        edit4.modified4 = { 0x40, 0x06, 0x00, 0x00, 0x0F, 0x85, 0xB0, 0x00, 0x00, 0x00, 0x8B, 0x5C, 0x24, 0x48, 0x81, 0xFB, 0xB0, 0x04 };  // 1600 x 1200
        edit4.offset4 = 0;
        break;
    case 8:
        edit4.modified4 = { 0x00, 0x0F, 0x00, 0x00, 0x0F, 0x85, 0xB0, 0x00, 0x00, 0x00, 0x8B, 0x5C, 0x24, 0x48, 0x81, 0xFB, 0x00, 0x04 };  // 3840 x 1024
        edit4.offset4 = 0;
        break;
    case 9:
        edit4.modified4 = { 0x70, 0x17, 0x00, 0x00, 0x0F, 0x85, 0xB0, 0x00, 0x00, 0x00, 0x8B, 0x5C, 0x24, 0x48, 0x81, 0xFB, 0x38, 0x04 };  // 6000 x 1080
        edit4.offset4 = 0;
        break;
    case 10:
        edit4.modified4 = { 0x80, 0x07, 0x00, 0x00, 0x0F, 0x85, 0xB0, 0x00, 0x00, 0x00, 0x8B, 0x5C, 0x24, 0x48, 0x81, 0xFB, 0xB0, 0x04 };  // 1920 x 1200
        edit4.offset4 = 0;
        break;
    default:
...
void PerformHexEdits4() {
    ...
    HexEdit4 edit = CreateHexEditFromResolution(resolutionIndex);
